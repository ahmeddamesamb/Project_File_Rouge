 ...
 */
final class Version20220804110400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `produit` (id INT AUTO_INCREMENT NOT NULL, gestionaire_id INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, description VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prix INT NOT NULL, etat_produit TINYINT(1) NOT NULL, quantity INT DEFAULT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_29A5EC2749C1252F (gestionaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
