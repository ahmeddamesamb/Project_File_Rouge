 ...
 */
final class Version20220819191532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, gestionaire_id INT DEFAULT NULL, livraison_id INT DEFAULT NULL, client_id INT DEFAULT NULL, zone_id INT DEFAULT NULL, etat_commande VARCHAR(50) NOT NULL, numero_commande VARCHAR(255) DEFAULT NULL, date_commande DATETIME NOT NULL, etat_paiement VARCHAR(255) NOT NULL, statut_commande VARCHAR(255) DEFAULT NULL, paiement INT DEFAULT NULL, numero_ticket INT DEFAULT NULL, INDEX IDX_6EEAA67D49C1252F (gestionaire_id), INDEX IDX_6EEAA67D8E54FB25 (livraison_id), INDEX IDX_6EEAA67D19EB6921 (client_id), INDEX IDX_6EEAA67D9F2C3FAB (zone_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE menu_taille (id INT AUTO_INCREMENT NOT NULL, menu_id INT DEFAULT NULL, taille_id INT DEFAULT NULL, quantity INT NOT NULL, INDEX IDX_A517D3E0CCD7E912 (menu_id), INDEX IDX_A517D3E0FF25611A (taille_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `produit` (id INT AUTO_INCREMENT NOT NULL, gestionaire_id INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, description VARCHAR(255) NOT NULL, nom VARCHAR(255) DEFAULT NULL, prix INT DEFAULT NULL, etat_produit VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_29A5EC2749C1252F (gestionaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tailleboisson (id INT AUTO_INCREMENT NOT NULL, taille_id INT DEFAULT NULL, boisson_id INT DEFAULT NULL, quantite_stock INT NOT NULL, INDEX IDX_122BF7E8FF25611A (taille_id), INDEX IDX_122BF7E8734B8089 (boisson_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, token VARCHAR(255) NOT NULL, is_enable TINYINT(1) NOT NULL, expire_at DATETIME NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', role VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE zone (id INT AUTO_INCREMENT NOT NULL, gestionaire_id INT DEFAULT NULL, nom_zone VARCHAR(255) NOT NULL, cout_livraison INT NOT NULL, etat_zone TINYINT(1) NOT NULL, INDEX IDX_A0EBC00749C1252F (gestionaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tailleboisson ADD CONSTRAINT FK_122BF7E8FF25611A FOREIGN KEY (taille_id) REFERENCES taille (id)');
        $this->addSql('ALTER TABLE tailleboisson ADD CONSTRAINT FK_122BF7E8734B8089 FOREIGN KEY (boisson_id) REFERENCES boisson (id)');
        $this->addSql('ALTER TABLE zone ADD CONSTRAINT FK_A0EBC00749C1252F FOREIGN KEY (gestionaire_id) REFERENCES gestionaire (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE tailleboisson DROP FOREIGN KEY FK_122BF7E8734B8089');
        ...
        $this->addSql('ALTER TABLE zone DROP FOREIGN KEY FK_A0EBC00749C1252F');
        ...
        $this->addSql('ALTER TABLE tailleboisson DROP FOREIGN KEY FK_122BF7E8FF25611A');
