 ...
 */
final class Version20220708181512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, gestionaire_id INT DEFAULT NULL, livraison_id INT DEFAULT NULL, client_id INT DEFAULT NULL, etat_commande TINYINT(1) NOT NULL, numero_commande INT DEFAULT NULL, date_commande DATETIME NOT NULL, etat_paiement TINYINT(1) NOT NULL, statut_commande TINYINT(1) DEFAULT NULL, paiement INT DEFAULT NULL, numero_ticket INT DEFAULT NULL, INDEX IDX_6EEAA67D49C1252F (gestionaire_id), INDEX IDX_6EEAA67D8E54FB25 (livraison_id), INDEX IDX_6EEAA67D19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE frite (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
